...
if (questions.length !== 20) throw new Error(`Expected 20 Python questions, found ${questions.length}.`);
for (const question of questions) {
  if (!question.prompt || question.options?.length !== 4 || question.correct < 0 || question.correct > 3) {
